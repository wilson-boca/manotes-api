...
class AuthServiceAuthenticateWithCredentialsTest(base.TestCase):
    ...
    @base.mock.patch('app.security.security_services.HashService.is_string_equals_to_hash', base.mock.MagicMock())
    @base.mock.patch('app.house.residents.User.create_with_username', base.mock.MagicMock())
    @base.mock.patch('app.security.security_services.ValidationService.is_email')
    ...
    @base.mock.patch('app.security.security_services.HashService.is_string_equals_to_hash', base.mock.MagicMock())
    @base.mock.patch('app.house.residents.User.create_with_email')
    @base.mock.patch('app.security.security_services.ValidationService.is_email')
    ...
    @base.mock.patch('app.security.security_services.HashService.is_string_equals_to_hash', base.mock.MagicMock())
    @base.mock.patch('app.house.residents.User.create_with_email', base.mock.MagicMock(side_effect=exceptions.NotFound))
    @base.mock.patch('app.security.security_services.ValidationService.is_email')
    ...
    @base.mock.patch('app.security.security_services.HashService.is_string_equals_to_hash')
    @base.mock.patch('app.house.residents.User.create_with_username')
    @base.mock.patch('app.security.security_services.ValidationService.is_email')
...
class AuthServiceAuthenticateWithTokenTest(base.TestCase):
    ...
    @base.mock.patch('app.security.authentication.g', base.mock.MagicMock())
    ...
    @base.mock.patch('app.security.authentication.g')
    @base.mock.patch('app.house.residents.User.create_with_token')
