...
class TokenServiceGenerateTokenTest(base.TestCase):
    ...
    @base.mock.patch('app.security.security_services.secrets.token_hex')
...
class HashServiceHashTest(base.TestCase):
    ...
    @base.mock.patch('app.security.security_services.pbkdf2_sha256.hash')
...
class SecurityServiceIsStringEqualsToHashTest(base.TestCase):
    ...
    @base.mock.patch('app.security.security_services.pbkdf2_sha256.verify')
...
class ValidationServiceTest(base.TestCase):
    ...
    @base.mock.patch('app.security.security_services.validate_email')
