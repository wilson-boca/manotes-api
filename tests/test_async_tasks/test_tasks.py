...
class StartSendEmailTest(base.TestCase):
    ...
    @base.mock.patch('app.async_tasks.tasks.send_email.apply_async', base.mock.MagicMock())
    @base.mock.patch('app.async_tasks.tasks.establish.logger.info')
    ...
    @base.mock.patch('app.async_tasks.tasks.establish.logger.info', base.mock.MagicMock())
    @base.mock.patch('app.async_tasks.tasks.send_email.apply_async')
...
class SendEmailTest(base.TestCase):
    ...
    @base.mock.patch('app.async_tasks.tasks.postman.Postman.send_confirmation_email')
