...
class AbstractModelUpdateFromDictTest(base.TestCase):
    ...
    @base.TestCase.mock.patch('app.models.AbstractModel.save_db', base.mock.MagicMock(side_effect=Exception))
    @base.TestCase.mock.patch('app.models.AbstractModel.set_values', base.mock.MagicMock())
...
class UserCreateFromDictTest(base.TestCase):
    ...
    @base.TestCase.mock.patch('app.models.db')
    @base.TestCase.mock.patch('app.models.User.save_db')
    @base.TestCase.mock.patch('app.models.User.set_values', base.mock.MagicMock())
    ...
    @base.TestCase.mock.patch('app.models.db')
    @base.TestCase.mock.patch('app.models.AbstractModel.save_db', base.mock.MagicMock())
    @base.TestCase.mock.patch('app.models.AbstractModel.set_values')
    ...
    @base.TestCase.mock.patch('app.models.AbstractModel.save_db', base.mock.MagicMock(side_effect=Exception('manotes_users_email_key')))
    @base.TestCase.mock.patch('app.models.AbstractModel.set_values', base.mock.MagicMock())
    ...
    @base.TestCase.mock.patch('app.models.AbstractModel.save_db', base.mock.MagicMock(side_effect=Exception('manotes_users_username_key')))
    @base.TestCase.mock.patch('app.models.AbstractModel.set_values', base.mock.MagicMock())
